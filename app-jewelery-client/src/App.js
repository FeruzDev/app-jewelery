    ...
    return (
        <BrowserRouter>
            ...
            <Switch>
                ...
                <Route exact path="/admin/users" component={AdminUsers} role="admin"/>
                <Route exact path="/admin/workers" component={DirectorUsers} role="director"/>
                <Route exact path="/admin/jewelery" component={Jewelery} role="director"/>
